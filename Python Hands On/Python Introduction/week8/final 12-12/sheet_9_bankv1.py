...
class Customer:
    ...
    def __str__(self):
        ...
        return "[Customer ID=" + str(Customer.cust_id) \
              + " LASTNAME=$" + str(self.ln) \
              + " AGE=" + str(self.age)+ "]"
...
class Bank:
    ...
    def add_customer(self, customer):
        ...
        print('Addung ',self.customer)
        customerlist.append(self.customer)
    ...
    def add_account(self, account):
        ...
        print('adding accounts',self.account)
